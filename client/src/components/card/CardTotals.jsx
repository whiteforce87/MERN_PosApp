    ...
    <div className="cart h-full max-h-[calc(100vh_-_90px)] flex flex-col">
      ...
      <div className="cart-totals mt-auto">
        <div className="border-t border-b">
          ...
          <div className="flex justify-between p-2">
            <b>KDV %{cart.tax}</b>
            <span className="text-red-700">{((cart.total * cart.tax)/100) > 0 ? `+${((cart.total * cart.tax)/100).toFixed(2)}`
            : 0 }₺</span>
          </div>
        </div>
        <div className="border-b mt-4">
          <div className="flex justify-between p-2">
            ...
            <span className="text-xl">{(cart.total +(cart.total * cart.tax)/100 ) > 0 ? (cart.total +(cart.total * cart.tax)/100 ).toFixed(2)
            : 0 }₺</span>
          </div>
        </div>
